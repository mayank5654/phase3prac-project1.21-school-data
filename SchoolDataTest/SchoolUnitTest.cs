...
namespace SchoolDataTest
{
    ...
    public class SchoolUnitTest
    {
        ...
        public void AddStudent()
        {
            ...
            var student = new Student { StudentId = 1, StudentName = "Nirmal Raj", Class = "Class 10" };
        ...
        public void StudentMockTest()
        {
            ...
            studentMock.SetupGet(s => s.StudentName).Returns("mayank kaushal");
        ...
        public void TeacherMockTest()
        {
            ...
            teacherMock.SetupGet(s => s.TeacherName).Returns("Mr.sanjay");
